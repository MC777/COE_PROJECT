...
INSERT INTO `coe`.`userroles` (`id_user_role`, `description`, `role`, `user_id`) VALUES ('1', 'admin role', 'admin', '1');
INSERT INTO `coe`.`userroles` (`id_user_role`, `description`, `role`, `user_id`) VALUES ('2', 'user role', 'user', '2');
