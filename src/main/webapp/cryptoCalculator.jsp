    ...
    <div class="container"> <button class="navbar-toggler navbar-toggler-right border-0" type="button" data-toggle="collapse" data-target="#navbar12" style="">
        ...
        <div class="collapse navbar-collapse" id="navbar12"> <a href="#" class="navbar-brand d-none d-md-block w-25">
            ...
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item"> <a class="nav-link" href="#">Kryptowaluty</a> </li>
                <li class="nav-item"> <a class="nav-link" href="#">Pomoc</a> </li>
                <li class="nav-item"> <a class="nav-link" href="#">Kontakt</a> </li>
            </ul>
            <ul class="navbar-nav">
                <li class="nav-item"> <a class="nav-link" href="#">Zaloguj się</a> </li>
                <li class="nav-item"> <a class="nav-link text-primary" href="#">Zarejestruj się</a> </li>
            </ul>
        </div>
    </div>
</nav>
...
<div class="py-5 mr-5 d-flex flex-grow-0" style="">
    <div class="container">
    </div>
</div>
<div class="py-1" >
        ...
        <div class="row">
            <div class="col-md-11" style="">
                <div class="embed-responsive embed-responsive-16by9" style="">
                    <iframe src="https://www.youtube.com/embed/LTxQOYE5RJY?controls=0" allowfullscreen="" class="embed-responsive-item"></iframe>
                </div>
            </div>
        </div>
    </div>
